!(function (e) {
  function t(t) {
    for (
      var n, i, l = t[0], f = t[1], a = t[2], p = 0, s = [];
      p < l.length;
      p++
    )
      (i = l[p]),
  ...
  (i.m = e),
    ...
    (i.p = "/neurodesign_sonification/");
  var l = (this.webpackJsonpclient = this.webpackJsonpclient || []),
    f = l.push.bind(l);
  (l.push = t), (l = l.slice());
...
//# sourceMappingURL=runtime-main.fbed0c6f.js.map
